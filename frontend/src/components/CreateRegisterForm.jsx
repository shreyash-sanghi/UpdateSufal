...
const saveRegister = async(event)=>{
   ...
   const result = await axios.post(`${import.meta.env.VITE_Backend_URL}/save_register`,
...
const getdata = async()=>{
  try{
const response = await axios.get(`${import.meta.env.VITE_Backend_URL}/get_registerdata_byid/${rid}`);
