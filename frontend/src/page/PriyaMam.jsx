  ...
  return (
    <div className="w-full  rounded-2xl   border border-[#16191e29] flex flex-col items-center justify-center shadow-md select-none">
      ...
      <div className="px-4 py-3 w-full flex flex-col text-center  space-y-1.5">
        <h1 className="text-lg bg-pink-600 px-4 text-white rounded-xl mt-2 py-1.5 font-semibold">
          {teamMemberName}
        </h1>
...
<div className="container mx-auto my-8">
      ...
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 pb-10 justify-center text-center place-content-center items-center sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
